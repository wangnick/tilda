...
uint8_t usiTwiAmountDataInTransmitBuffer(void)
{
    return (txHead-txTail) & TWI_TX_BUFFER_MASK;
}
 
uint8_t usiTwiAmountFreeInTransmitBuffer(void)
{
    return TWI_TX_BUFFER_SIZE - usiTwiAmountDataInTransmitBuffer();
}
...
{
    return (rxHead-rxTail) & TWI_RX_BUFFER_MASK;
}
 
uint8_t usiTwiAmountFreeInReceiveBuffer(void)
{
    return TWI_TX_BUFFER_SIZE - usiTwiAmountDataInReceiveBuffer();
}
